...
def human_timedelta(
    ...
    *,
    ...
    """
    A function that humanizes a timedelta.
    """
...
def size(value: int):
    """
    A function that humanizes a size.
    """
...
def time(value: timedelta, short: bool = False):
    """
    A function that humanizes a time.
    """
    value = (
...
def ordinal(value: int):
    """
    A function that humanizes an ordinal.
    """
...
def comma(value: int):
    """
    A function that humanizes a comma.
    """
...
def percentage(small: int, big: int = 100):
    """
    A function that humanizes a percentage.
    """
