...
from heist.framework.tools.converters import regex
from heist.framework import Context
from heist.framework.tools.utilities import human_join
...
class SynthEngine(Converter):
    ...
    async def convert(ctx: Context, argument: str) -> str:
        """
        A converter that converts a string to a synth engine.
        """
        voices = dict(
            male="en_au_002",
...
def time(value: timedelta, short: bool = False):
    """
    A function that converts a timedelta to a human readable string.
    """
    value = (
...
class TimeConverter(Converter):
    """
    A converter that converts a string to a time.
    """
    @staticmethod
    ...
    async def convert(self, ctx: Context, argument: str):
        """
        A method that converts a string to a time.
        """
...
class Emoji:  # noqa: F811
    def __init__(self, name: str, url: str, **kwargs):
        """
        A method that initializes the emoji.
        """
        self.name: str = name
        self.url: str = url
    ...
    def __str__(self):
        """
        A method that returns the emoji as a string.
        """
        if self.id:
...
class EmojiFinder(Converter):
    """
    A converter that converts a string to an emoji.
    """
    @staticmethod
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to an emoji.
        """
...
class Percentage(Converter):
    """
    A converter that converts a string to a percentage.
    """
    @staticmethod
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a percentage.
        """
        if argument.isdigit():
...
def get_language(value: str):
    """
    A function that gets a language from a string.
    """
    value = value.lower()
...
class Language(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a language.
        """
...
class Role(RoleConverter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a role.
        """
        role = None
...
class Roles(RoleConverter):
    """
    A converter that converts a string to a list of roles.
    """
    @staticmethod
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a list of roles.
        """
        roles = []
...
class Member(MemberConverter):
    async def convert(
        ...
        """
        A method that converts a string to a member.
        """
    ...
    async def hierarchy(
        ...
        """
        A method that checks if a member is hierarchy.
        """
...
class ImageFinder(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to an image.
        """
        try:
    ...
    async def search(self, history: bool = True):
        """
        A method that searches for an image.
        """
...
class Bitrate(Converter):
    ...
    async def convert(ctx: Context, argument: str) -> int:
        """
        A method that converts a string to a bitrate.
        """
        if argument.isdigit():
            argument = int(argument)
...
class Region(Converter):
    ...
    async def convert(ctx: Context, argument: str) -> int:
        """
        A method that converts a string to a region.
        """
...
class ChartSize(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a chart size.
        """
...
class Date(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a date.
        """
...
class Command(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a command.
        """
...
class Status(Converter):
    async def convert(
        ...
        """
        A method that converts a string to a status.
        """
...
class State(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a state.
        """
        if argument.lower() in {
            "on",
            "yes",
...
class StickerFinder(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a sticker.
        """
        try:
    ...
    async def search(self):
        """
        A method that searches for a sticker.
        """
...
class MediaFinder(Converter):
    ...
    async def convert(ctx: Context, argument: str):
        """
        A method that converts a string to a media.
        """
        try:
            member = await Member().convert(ctx, argument)
            if member:
    ...
    async def search(self, history: bool = True):
        """
        A method that searches for a media.
        """
        if message := self.replied_message:
            for attachment in message.attachments:
                if attachment.content_type.split("/", 1)[
...
class Color(Converter):
    ...
    async def convert(
        ...
        """
        A method that converts a string to a color.
        """
